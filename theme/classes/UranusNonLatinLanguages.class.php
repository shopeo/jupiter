...
if ( ! class_exists( 'UranusNonLatinLanguages' ) ) {
	class UranusNonLatinLanguages {
		public static function get_non_latin_css( $type = 'front-end' ) {
			...
			$font_family = apply_filters(
				'uranus_get_localized_font_family_types',
				array(
			...
			$elements = apply_filters(
				'uranus_get_localized_font_family_elements',
				array(
					'front-end'      => array(
						'body',
						'input',
			...
			return uranus_generate_css( implode( ',', $elements[ $type ] ), 'font-family', implode( ',', $font_family[ $locale ] ), null, null, false );
		}
	}
}